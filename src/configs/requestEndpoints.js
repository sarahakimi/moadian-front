export default {
  getCompaniesFromSuperAdminPageEndpoint: '/user/admin/all',
  singleCompany: id => `user/admin/${id}`,
  registerEndpoint: 'auth/login',
  storageTokenKeyName: 'access_Token',
  registerCompany: 'user/admin/register',
  getusers: 'explanation',
  singleUser: id => `explanation/${id}`,
  registerUser: 'explanation',
  ...
  validatePhoneByToken: 'auth/validate_phone_by_token',
