...
function ACLPage() {
  ...
  const filterOperators = getGridStringOperators().filter(({value}) => ['contains' /* add more over time */].includes(value),);
  ...
  const setVerified = () => {
    ...
    toast.promise(editUser(selectedDriver.id, {...selectedDriver, verified: true})
      .then(() => {
        setChange(true)
        handleClose()
      }), {
      ...
      >
        ...
        <Box sx={{...style}}>
          ...
          >
            <Grid container spacing={2} mb={2}>
              <Grid item xs={12} sm={12} md={6} lg={3} xl={3}>
                ...
                <TextField
                  ...
                  label='کدملی'
                  value={selectedDriver.natural_code}
                  dir='ltr'
                  disabled
                  fullWidth
                />
              ...
              <Grid item xs={12} sm={12} md={6} lg={3} xl={3}>
                <TextField
                  ...
                  value={selectedDriver.vehicle_card_id}
                  disabled
                />
              </Grid>
              <Grid item xs={12} sm={12} md={6} lg={3} xl={3}>
                <TextField
                  label='پلاک'
                  value={selectedDriver.vehicle_plaque}
                  disabled
                  fullWidth
                />
              </Grid>
            ...
            <Box>
              <Button variant="contained" color="primary" onClick={setVerified} sx={{mx: 2}}>انتخاب </Button>
